    ...
    var r = function (n) {
        ...
        TableTools.BUTTONS = {
            csv: f.extend({}, TableTools.buttonBase, {
                sAction: "flash_save",
                sButtonClass: "DTTT_button_csv hidden",
                sButtonText: "CSV",
                sFieldBoundary: '"',
                sFieldSeperator: ",",
            ...
            xls: f.extend({}, TableTools.buttonBase, {
                ...
                sCharSet: "utf16le",
                bBomInc: !0,
                sButtonClass: "DTTT_button_xls hidden",
                sButtonText: "Excel",
                fnClick: function (a, b, c) {
                    this.fnSetText(c, this.fnGetTableData(b))
                }
            ...
            copy: f.extend({}, TableTools.buttonBase, {
                sAction: "flash_copy",
                sButtonClass: "DTTT_button_copy hidden",
                sButtonText: "Copy",
                fnClick: function (a, b, c) {
                    this.fnSetText(c, this.fnGetTableData(b))
                },
            ...
            pdf: f.extend({}, TableTools.buttonBase, {
                ...
                sNewLine: "\n",
                sFileName: "*.pdf",
                sButtonClass: "DTTT_button_pdf hidden",
                sButtonText: "PDF",
            ...
            print: f.extend({},
                TableTools.buttonBase, {
                    ...
                    sButtonClass: "DTTT_button_print hidden",
                    sButtonText: "Print",
